...
Verify DIMM:1 SummaryState timing
    ...
    Verify Time Delta    DIMM    command_disabled    logevent_summaryState    index=1
...
Verify DIMM:1 ConfigurationApplied Event timing
    ...
    Verify Time Delta    DIMM    command_disabled    logevent_configurationApplied    index=1
...
Verify DIMM:2 SummaryState timing
    [Tags]    software_versions    timing
    Verify Time Delta    DIMM    command_disabled    logevent_summaryState    index=2
...
Verify DIMM:2 ConfigurationApplied Event timing
    [Tags]    config_applied    timing
    Verify Time Delta    DIMM    command_disabled    logevent_configurationApplied    index=2
...
Verify ESS:1 SummaryState timing
    [Tags]    software_versions    timing
    Verify Time Delta    ESS    command_disabled    logevent_summaryState    index=1
...
Verify ESS:1 ConfigurationApplied Event timing
    [Tags]    config_applied    timing
    Verify Time Delta    ESS    command_disabled    logevent_configurationApplied   index=1
...
Verify ESS:101 SummaryState timing
    [Tags]    software_versions    timing
    Verify Time Delta    ESS    command_disabled    logevent_summaryState    index=101
...
Verify ESS:101 ConfigurationApplied Event timing
    [Tags]    config_applied    timing
    Verify Time Delta    ESS    command_disabled    logevent_configurationApplied    index=101
...
Verify ESS:102 SummaryState timing
    [Tags]    software_versions    timing
    Verify Time Delta    ESS    command_disabled    logevent_summaryState    index=102
...
Verify ESS:102 ConfigurationApplied Event timing
    [Tags]    config_applied    timing
    Verify Time Delta    ESS    command_disabled    logevent_configurationApplied    index=102
...
Verify ESS:103 SummaryState timing
    [Tags]    software_versions    timing
    Verify Time Delta    ESS    command_disabled    logevent_summaryState    index=103
...
Verify ESS:103 ConfigurationApplied Event timing
    [Tags]    config_applied    timing
    Verify Time Delta    ESS    command_disabled    logevent_configurationApplied    index=103
...
Verify ESS:104 SummaryState timing
    [Tags]    software_versions    timing
    Verify Time Delta    ESS    command_disabled    logevent_summaryState    index=104
...
Verify ESS:104 ConfigurationApplied Event timing
    [Tags]    config_applied    timing
    Verify Time Delta    ESS    command_disabled    logevent_configurationApplied    index=104
...
Verify ESS:105 SummaryState timing
    [Tags]    software_versions    timing
    Verify Time Delta    ESS    command_disabled    logevent_summaryState    index=105
...
Verify ESS:105 ConfigurationApplied Event timing
    [Tags]    config_applied    timing
    Verify Time Delta    ESS    command_disabled    logevent_configurationApplied    index=105
...
Verify ESS:106 SummaryState timing
    [Tags]    software_versions    timing
    Verify Time Delta    ESS    command_disabled    logevent_summaryState    index=106
...
Verify ESS:106 ConfigurationApplied Event timing
    [Tags]    config_applied    timing
    Verify Time Delta    ESS    command_disabled    logevent_configurationApplied    index=106
...
Verify ESS:201 SummaryState timing
    [Tags]    software_versions    timing
    Verify Time Delta    ESS    command_disabled    logevent_summaryState    index=201
...
Verify ESS:201 ConfigurationApplied Event timing
    [Tags]    config_applied    timing
    Verify Time Delta    ESS    command_disabled    logevent_configurationApplied    index=201
...
Verify ESS:202 SummaryState timing
    [Tags]    software_versions    timing
    Verify Time Delta    ESS    command_disabled    logevent_summaryState    index=202
...
Verify ESS:202 ConfigurationApplied Event timing
    [Tags]    config_applied    timing
    Verify Time Delta    ESS    command_disabled    logevent_configurationApplied    index=202
...
Verify ESS:203 SummaryState timing
    [Tags]    software_versions    timing
    Verify Time Delta    ESS    command_disabled    logevent_summaryState    index=203
...
Verify ESS:203 ConfigurationApplied Event timing
    [Tags]    config_applied    timing
    Verify Time Delta    ESS    command_disabled    logevent_configurationApplied    index=203
...
Verify ESS:204 SummaryState timing
    [Tags]    software_versions    timing
    Verify Time Delta    ESS    command_disabled    logevent_summaryState    index=204
...
Verify ESS:204 ConfigurationApplied Event timing
    [Tags]    config_applied    timing
    Verify Time Delta    ESS    command_disabled    logevent_configurationApplied    index=204
...
Verify ESS:301 SummaryState timing
    [Tags]    software_versions    timing
    Verify Time Delta    ESS    command_disabled    logevent_summaryState    index=301
...
Verify ESS:301 ConfigurationApplied Event timing
    [Tags]    config_applied    timing
    Verify Time Delta    ESS    command_disabled    logevent_configurationApplied    index=301
