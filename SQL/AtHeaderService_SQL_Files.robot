...
Verify AtHeaderService State Command enable SQL defintion files exist
    [Tags]    sql
...
Verify AtHeaderService State Command disable SQL defintion files exist
    [Tags]    sql
...
Verify AtHeaderService State Command abort SQL defintion files exist
    [Tags]    sql
    @{files}=    List Directory    ${SALWorkDir}/sql    pattern=atHeaderService_*abort*
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/sql/atHeaderService_command_abort.sqldef
    File Should Exist    ${SALWorkDir}/sql/atHeaderService_command_abort.sqlwrt
    File Should Exist    ${SALWorkDir}/sql/atHeaderService_command_abort_items.sql

Verify AtHeaderService State Command enterControl SQL defintion files exist
    [Tags]    sql
...
Verify AtHeaderService State Command exitControl SQL defintion files exist
    [Tags]    sql
...
Verify AtHeaderService State Command standby SQL defintion files exist
    [Tags]    sql
...
Verify AtHeaderService State Command start SQL defintion files exist
    [Tags]    sql
...
Verify AtHeaderService State Command stop SQL defintion files exist
    [Tags]    sql
    @{files}=    List Directory    ${SALWorkDir}/sql    pattern=atHeaderService_*stop*
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/sql/atHeaderService_command_stop.sqldef
    File Should Exist    ${SALWorkDir}/sql/atHeaderService_command_stop.sqlwrt
    File Should Exist    ${SALWorkDir}/sql/atHeaderService_command_stop_items.sql
