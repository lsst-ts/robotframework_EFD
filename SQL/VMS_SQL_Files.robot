...
Verify VMS State Command enable SQL defintion files exist
    [Tags]    sql
...
Verify VMS State Command disable SQL defintion files exist
    [Tags]    sql
...
Verify VMS State Command abort SQL defintion files exist
    [Tags]    sql
    @{files}=    List Directory    ${SALWorkDir}/sql    pattern=vms_*abort*
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/sql/vms_command_abort.sqldef
    File Should Exist    ${SALWorkDir}/sql/vms_command_abort.sqlwrt
    File Should Exist    ${SALWorkDir}/sql/vms_command_abort_items.sql

Verify VMS State Command enterControl SQL defintion files exist
    [Tags]    sql
    @{files}=    List Directory    ${SALWorkDir}/sql    pattern=vms_*enterControl*
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/sql/vms_command_enterControl.sqldef
    File Should Exist    ${SALWorkDir}/sql/vms_command_enterControl.sqlwrt
    File Should Exist    ${SALWorkDir}/sql/vms_command_enterControl_items.sql

Verify VMS State Command exitControl SQL defintion files exist
    [Tags]    sql
    @{files}=    List Directory    ${SALWorkDir}/sql    pattern=vms_*exitControl*
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/sql/vms_command_exitControl.sqldef
    File Should Exist    ${SALWorkDir}/sql/vms_command_exitControl.sqlwrt
    File Should Exist    ${SALWorkDir}/sql/vms_command_exitControl_items.sql

Verify VMS State Command standby SQL defintion files exist
    [Tags]    sql
...
Verify VMS State Command start SQL defintion files exist
    [Tags]    sql
...
Verify VMS State Command stop SQL defintion files exist
    [Tags]    sql
    @{files}=    List Directory    ${SALWorkDir}/sql    pattern=vms_*stop*
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/sql/vms_command_stop.sqldef
    File Should Exist    ${SALWorkDir}/sql/vms_command_stop.sqlwrt
    File Should Exist    ${SALWorkDir}/sql/vms_command_stop_items.sql
