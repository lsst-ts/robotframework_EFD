...
Verify HeaderService State Command enable SQL defintion files exist
    [Tags]    sql
...
Verify HeaderService State Command disable SQL defintion files exist
    [Tags]    sql
...
Verify HeaderService State Command abort SQL defintion files exist
    [Tags]    sql
    @{files}=    List Directory    ${SALWorkDir}/sql    pattern=headerService_*abort*
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/sql/headerService_command_abort.sqldef
    File Should Exist    ${SALWorkDir}/sql/headerService_command_abort.sqlwrt
    File Should Exist    ${SALWorkDir}/sql/headerService_command_abort_items.sql

Verify HeaderService State Command enterControl SQL defintion files exist
    [Tags]    sql
...
Verify HeaderService State Command exitControl SQL defintion files exist
    [Tags]    sql
...
Verify HeaderService State Command standby SQL defintion files exist
    [Tags]    sql
...
Verify HeaderService State Command start SQL defintion files exist
    [Tags]    sql
...
Verify HeaderService State Command stop SQL defintion files exist
    [Tags]    sql
    @{files}=    List Directory    ${SALWorkDir}/sql    pattern=headerService_*stop*
    Log Many    @{files}
    File Should Exist    ${SALWorkDir}/sql/headerService_command_stop.sqldef
    File Should Exist    ${SALWorkDir}/sql/headerService_command_stop.sqlwrt
    File Should Exist    ${SALWorkDir}/sql/headerService_command_stop_items.sql
