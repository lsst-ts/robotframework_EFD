...
Verify FiberSpectrograph:101 Enabled
    [Tags]    enabled
    Verify Summary State    ${STATES}[enabled]    FiberSpectrograph:101
...
Verify FiberSpectrograph:102 Enabled
    [Tags]    enabled
    Verify Summary State    ${STATES}[enabled]    FiberSpectrograph:102
