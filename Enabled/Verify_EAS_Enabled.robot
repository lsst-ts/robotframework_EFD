...
# ESS:118    
Verify ESS:118 Enabled
    [Tags]    enabled
    Verify Summary State    ${STATES}[enabled]    ESS:118
...
# ESS:119    
Verify ESS:119 Enabled
    [Tags]    enabled
    Verify Summary State    ${STATES}[enabled]    ESS:119
...
# ESS:120
Verify ESS:120 Enabled   
    [Tags]    enabled    
    Verify Summary State    ${STATES}[enabled]    ESS:120
