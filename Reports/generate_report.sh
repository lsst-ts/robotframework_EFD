...
robot_outputs=(offline.xml standby.xml disabled.xml enabled.xml housekeeping.xml at_image_verify.xml cc_image_verify.xml at_prep_onsky.xml at_cwfs_align.xml at_acq_take_seq_pointing.xml at_acq_take_seq_verify.xml at_acq_take_seq_test.xml at_acq_take_seq_nominal.xml at_stop.xml shutdown.xml)
